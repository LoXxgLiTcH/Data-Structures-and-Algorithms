/* To run this code, enter the following commands in the Terminal					/
/	1. To go to the file directory -> cd .\Exam-Questions\Sabado-Cipher-Decoding\ 	/
/	2. To create an executable file for the code -> gcc main.c decode.c -o main 	/
/	3. To run the code -> ./main.exe 											   */ 
#include <stdio.h>
#include <stdlib.h>
#include "decode.h"
